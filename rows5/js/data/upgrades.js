...
var all_upgrades = {
	...
	boss_chance:{
		name: 			'Boss chance',
		description: 	'Increases the chance a boss appears after defeating a 100% power or stronger enemy by 1%. Base chance is 1%.',
		needed_upgrades:{
			z_a_town_access: 	1,
			aab_summon_rarity: 30,
		},
	...
	boss_power:{
		name: 			'Boss power',
		description: 	'Increases the power of bosses by 20%. Base power of bosses is 200%.',
		needed_upgrades:{
			boss_chance: 	1,
		},
		card_image: 	'golden_saddle',
		type: 			'boss_power',
		subtypes:  		['any'],
		amount: 		0.1,
		level_cost_scale: 	1,
