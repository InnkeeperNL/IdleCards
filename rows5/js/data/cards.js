var all_available_cards = {
	...
	corn_on_the_cob:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{restore_chance: 25, popped_by_fire: 1},
	...
	falcon:{
		...
		hero_version: 			{
			theme: 				['flying_ability','empower_hero_ability','heal_hero_ability','active_healing_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
	...
	popcorn:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{shoot_unit_av: 1, restore_chance: 25},
	...
	ripe_banana:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{hasten: 1, empower_hero: 1, fragile: 20},
	...
	steak:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{restore: 1, empower_hero: 1},
