var all_available_cards = {
	...
	abbot:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/abbot.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			7,
		abilities: 			{strike: 1, bolster_all: 1},
		hero_version: 			{
			theme: 				['subtype_cleric','active_healing_ability','cleanse_ally_ability','empower_ally_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, bolster: 1},
		},
		quote: '\"I will guide the flock.\"',
	},
	alchemist:{
		name: 				'alchemist',
		type: 				'creature',
		...
		hero_version: 			{
			theme: 				['subtype_potion','heal_ally_ability','cleanse_ally_ability','fortify_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, brew_potion: 3},
		},
	...
	ambush_archer:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/ambush_archer.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			5,
		abilities: 			{shoot: 1, shoot_arrivals: 5},
		hero_version: 			{
			theme: 				['projectile_ability','subtype_warrior','move_enemy_to_hand_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{shoot_unit: 1, shoot_arrivals: 5},
		},
		quote: '\"I will get them as soon as they come near.\"',
	},
	ambusher:{
		name: 				'ambusher',
		type: 				'creature',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/ambusher.jpg',
		image_position: 	'top',
		power: 				2,
		armor: 				0,
		health: 			4,
		abilities: 			{strike: 1, strike_arrival: 5, stealth: 1, retreat_on_kill: 1},
		hero_version: 			{
			theme: 				['enemy_unit_card_played_proc_ability','subtype_rogue','move_enemy_to_hand_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, strike_arrivals: 5, hide_on_kill: 1},
		},
		quote: '\"Strike from the shadows.\"',
	},
	apprentice:{
		name: 				'apprentice',
		type: 				'creature',
	...
	arcane_druid:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/arcane_druid.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			5,
		abilities: 			{arcane_bolt: 1, heal: 1, cleanse: 2},
		hero_version: 			{
			theme: 				['subtype_cleric','subtype_mage','type_creature'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{arcane_bolt_hv: 1, heal: 1, cleanse: 1},
		},
		quote: '\"Her magic comes from the forest.\"',
	},
	arcane_mage:{
		name: 				'arcane mage',
		type: 				'creature',
		...
		hero_version: 			{
			theme: 				['damaging_hero','subtype_mage'],
		...
		quote: '\"Cover the battlefield with magical energy.\"',
	},
	arcane_scout:{
		name: 				'arcane scout',
		type: 				'creature',
		subtypes: 			['human','mage','rogue'],
		color: 				['colorless'],
		theme: 				[],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/arcane_scout.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			4,
		abilities: 			{arcane_bolt: 1, run_away: 1, coward: 1},
		hero_version: 			{
			theme: 				['subtype_mage','damaging_hero','evade_ability','movement_ability'],
			not_theme: 			['empower_hero_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
	...
	archmage:{ 
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/archmage.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			8,
		abilities: 			{arcane_bolt: 3, hasten_on_kill: 3},
		hero_version: 			{
			theme: 				['subtype_mage','damaging_hero','draw_cards_ability'],
			not_theme: 			['empower_hero_ability','empower_ally_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{arcane_bolt_hv: 2, hasten_on_kill: 1},
		},
		quote: '\"Magic so powerful it can bend time.\"',
	},
	armaments:{
		name: 				'armaments',
		type: 				'spell',
		...
		armor: 				0,
		health: 			false,
		abilities: 			{empower_all: 1, fortify_all: 1, minimum_allies: 3, righthand: 1},
	...
	assassins_quiver:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/assassins_quiver.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{shoot_arrivals: 2, cursed_touch: 2, venom: 2},
		quote: '\"They will not make it to the battlefield.\"',
	},
	attack_dog:{
		name: 				'attack dog',
		type: 				'creature',
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, adrenaline_hv: 1, frenzy: 1},
		},
	...
	baby_mammoth:{
		name: 				'baby mammoth',
		type: 				'creature',
		subtypes: 			['animal','trunked'],
		color: 				['colorless'],
		theme: 				[],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/baby_mammoth.jpg',
		image_position: 	'top right',
		power: 				1,
		armor: 				0,
		health: 			4,
		abilities: 			{empowered_by_enemies: 1, strike: 1, trample: 1},
		hero_version: 			{
			theme: 				['empower_ally_ability','subtype_trunked','victory_rush_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
	...
	badger:{
		...
		armor: 				0,
		health: 			4,
		abilities: 			{strike: 1, enrage: 4},
		hero_version: 			{
			theme: 				['heal_ally_ability','subtype_carnivore','empower_ally_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, enrage_hv: 10},
		},
		quote: '\"Strong and very aggressive.\"',
	},
	baked_pufferfish:{
		name: 				'baked pufferfish',
		type: 				'artifact',
		subtypes: 			['food'],
		color: 				['colorless'],
		theme: 				[],
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/baked_pufferfish.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{poisonous_hero: 1, fragile: 6},
		quote: '\"Come and have a bite! It\'s completely safe!\"',
	},
	banquet:{
		name: 				'banquet',
		type: 				'spell',
		subtypes: 			['food'],
		color: 				['colorless'],
		theme: 				['type_artifact','aoe'],
		not_theme: 			[],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/banquet.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{bring_food: 3, bring_human: 3},
		quote: '\"Lure them over with food...\"',
		max_in_deck: 1,
	},
	battle_preparations:{
	...
	blaze:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/blaze.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{burn_all: 1, echo: 1},
		quote: '\"Enjoy the fire!\"',
	},
	blaze_giant:{
		name: 				'blaze giant',
		type: 				'creature',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/blaze_giant.jpg',
		image_position: 	'top',
		power: 				3,
		armor: 				0,
		health: 			10,
		abilities: 			{burning_entry: 2, empowering_fire: 1, strike: 1, trample: 1},
		hero_version: 			{
			theme: 				['burn_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{empowering_fire: 1, strike_unit: 1, burn_arrivals: 1},
		},
		quote: '\"He leaves a trail of fire.\"',
	},
	blight_rat:{
		name: 				'blight rat',
		type: 				'creature',
		...
		armor: 				0,
		health: 			2,
		abilities: 			{strike: 1, cursed_touch: 2, venom: 2, spread_blight: 1, call_rat: 3},
		hero_version: 			{
			theme: 				['poison_ability','curse_ability','subtype_rat'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 1, venom: 1, spread_blight: 1, call_rat: 1},
		},
	...
	bottle_of_poison:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{quicken_poison_hv: 1, venomous_hero: 4},
	...
	brain_drain:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/brain_drain.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{discard_enemy_down: 6, painful_discards: 1},
		quote: '\"My head hurts.\"',
		max_in_deck: 1,
	},
	breaking_ray:{
	...
	burning_skeleton:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, ignites: 1, burning_aura: 1, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','burn_ability','ally_creature_death_proc_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, ignites: 1, burning_aura: 1, resurrect_on_kill: 5, undead: 1},
		},
	...
	cheese:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/cheese.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{heal: 1, call_rat: 2, fragile: 5},
		quote: '\"Tasty and nutritious, but has a chance of attracting rodents.\"',
	},
	chef:{
		name: 				'chef',
		type: 				'creature',
		subtypes: 			['human','villager'],
		color: 				['colorless'],
		theme: 				['type_artifact','heal_hero_ability'],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/chef.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			5,
		...
		hero_version: 			{
			theme: 				['subtype_human','subtype_food'],
			not_theme: 			['type_artifact'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, prepare_food: 2},
		},
		quote: '\"You will love it!\"',
		max_in_deck: 2,
	},
	conscription:{
		name: 				'conscription',
	...
	corn_on_the_cob:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/corn_on_the_cob.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{restore_chance: 50, popped_by_fire: 1, fragile: 5},
		quote: '\"Tasty, but maybe we can improve on it somehow.\"',
		max_in_deck: 2,
	},
	creepy_mask:{
		name: 				'creepy mask',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/creepy_mask.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{fearful_hero: 5, slow_enemy_draws: 1},
		quote: '\"Do you dare to go into battle against that?\"',
	},
	crow:{
		name: 				'crow',
		type: 				'creature',
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, dooming_touch: 1, flying: 4},
		hero_version: 			{
			theme: 				['evade_ability','subtype_bird','run_away_ability','doom_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, dooming_touch: 1, flying: 4},
		},
	...
	crown_of_flames:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/crown_of_flames.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
	...
	cursed_boots:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/cursed_boots.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{curse_arrivals: 1},
		quote: '\"Walk a mile in those. I dare you.\"',
		max_in_deck: 		1,
	},
	cursed_scarecrow:{
	...
	cursed_skeleton:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/cursed_skeleton.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, cursed_touch: 1, cursed_aura: 1, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','poison_ability','ally_creature_death_proc_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 1, cursed_aura: 1, resurrect_on_kill: 5, undead: 1},
		},
		quote: '\"Cursed in life, cursed in death.\"',
	},
	cursed_talisman:{
	...
	dance_of_the_dead:{
		...
		subtypes: 			['ritual'],
		color: 				['colorless'],
		theme: 				['aoe','ally_creature_death_proc_ability'],
		not_theme: 			['subtype_mage'],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/dance_of_the_dead.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{summon_ghost: 5, maximum_allies: 0},
		quote: '\"Spooky, scary... ghosts.\"',
		max_in_deck: 2,
	},
	dark_fortress:{
		name: 				'dark fortress',
	...
	dark_knight:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/dark_knight.jpg',
		image_position: 	'top',
		power: 				3,
		armor: 				0,
		health: 			6,
		abilities: 			{charge: 1, strike: 1, trample: 1, cursed_aura: 2},
		hero_version: 			{
			theme: 				['movement_ability','curse_ability','trample_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, trample: 1, enrage_hv: 5, cursed_aura: 1},
		},
		quote: '\"Once provoked, he will ride you down.\"',
	},
	dark_night:{
		name: 				'dark night',
		type: 				'spell',
		...
		armor: 				0,
		health: 			false,
		abilities: 			{curse_all: 1, long_echo: 1},
	...
	dark_rat:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, cursed_touch: 1, spread_darkness: 1, call_rat: 3},
		hero_version: 			{
			theme: 				['curse_ability','subtype_rat'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 1, spread_darkness: 1, call_rat: 1},
		},
	...
	dark_rogue:{
		...
		armor: 				0,
		health: 			4,
		abilities: 			{strike: 1, cursed_touch: 1, evade: 3, healing_evasion: 4},
		hero_version: 			{
			theme: 				['subtype_rogue','curse_ability','evade_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 1, evade: 2, healing_evasion: 2},
		},
	...
	death_mage:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/death_mage.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			5,
		abilities: 			{arcane_bolt: 1, death_bolt: 1},
		hero_version: 			{
			theme: 				['ally_creature_death_proc_ability','own_death_proc_ability','summon_creature_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{arcane_bolt_hv: 1, death_bolt_hv: 1},
		},
		quote: '\"Once an ally dies, she will fire the energy released at the enemy.\"',
	},
	dooming_boots:{
		name: 				'dooming boots',
		type: 				'artifact',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/dooming_boots.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{doom_arrivals: 1},
		quote: '\"Wearing those will make you walk to your death.\"',
	},
	druid:{
		name: 				'druid',
		type: 				'creature',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/druid.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, heal: 1, cleanse: 2},
		hero_version: 			{
			theme: 				['subtype_cleric','type_creature'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, heal: 1, cleanse: 2},
		},
		quote: '\"She comes from the forest.\"',
	},
	dwarf_adder:{
		name: 				'dwarf adder',
		type: 				'creature',
		...
		quote: '\"Something just bit my ankle!\"',
	},
	eager_cadet:{
		name: 				'eager cadet',
		type: 				'creature',
	...
	elephant:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/elephant.jpg',
		image_position: 	'top',
		power: 				3,
		armor: 				0,
		health: 			8,
		abilities: 			{strike: 1, trample: 1, enrage: 5},
		hero_version: 			{
			theme: 				['empower_ally_ability','subtype_trunked','victory_rush_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, frenzy: 1},
		},
		quote: '\"Do not give it room to charge!\"',
	},
	eruption:{
		name: 				'eruption',
		type: 				'spell',
		...
		armor: 				0,
		health: 			false,
		abilities: 			{burn_all_hv: 4, minimum_enemies: 3},
		quote: '\"Run away!\"',
	},
	falcon:{
		name: 				'falcon',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/falcon.jpg',
		power: 				1,
		armor: 				0,
		health: 			1,
		abilities: 			{seek_enemy: 1, strike: 1, precision: 1, adrenaline: 10, flying: 4},
		hero_version: 			{
			theme: 				['flying_ability','empower_hero_ability','heal_hero_ability','heal_ally_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, precision: 1, adrenaline_hv: 3, flying: 4},
		},
	...
	farmer:{
		...
		quote: '\"Just let us farm in peace!\"',
	},
	fire_assassin:{
		name: 				'fire assassin',
		type: 				'creature',
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, ignites: 1, hide: 1},
		},
	...
	fire_cleric:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, burning_deaths_hv: 2},
		},
	...
	fire_pit:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{burning_aura: 2, resist_fire: 1},
		hero_version: 			{
	...
	fire_smith:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/fire_smith.jpg',
		image_position: 	'top',
		power: 				2,
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, burn: 2, burn_ally: 2, empower_ally: 2},
		hero_version: 			{
			theme: 				['burn_ability','cleanse_ally_ability','physical_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, burn_hv: 2, burn_ally: 2, empower_ally: 2},
		},
		quote: '\"He forges the fire into a weapon.\"',
	},
	fire_witch:{
		name: 				'fire witch',
		type: 				'creature',
	...
	flame_boar:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, enrage_hv: 7, ignites: 1},
		},
	...
	flaming_boots:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/flaming_boots.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{burn_arrivals: 5},
		quote: '\"Walking on coal? What about lava?!\"',
	},
	flaming_sword:{
		name: 				'flaming sword',
		type: 				'artifact',
		...
		armor: 				0,
		health: 			false,
		abilities: 			{empower_hero: 1, igniting_hero: 4},
	...
	forge_tools:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/forge_tools.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{empower_ally: 5},
		quote: '\"Time to forge some weapons.\"',
	},
	forged_boots:{
		name: 				'forged boots',
		type: 				'artifact',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/forged_boots.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{empower_arrivals: 5},
		quote: '\"Those make you take big steps.\"',
		max_in_deck: 		1,
	},
	furnace:{
		name: 				'furnace',
		...
		armor: 				0,
		health: 			5,
		abilities: 			{burn: 2, empower_arrivals: 3},
		hero_version: 			{
			theme: 				['burn_ability','melee_ability'],
			not_theme: 			['empower_hero_ability','damaging_hero'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{burn_hv: 2, empower_arrivals: 3},
		},
		quote: '\"Careful! Hot!\"',
	},
	ghost:{
	...
	ghost_caller:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/ghost_caller.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, bring_ghost: 2, maximum_allies: 2},
		hero_version: 			{
			theme: 				['ally_creature_death_proc_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, summon_ghost_hv: 4},
		},
		quote: '\"They are here.\"',
	},
	giant_growth:{
		...
		subtypes: 			['ritual'],
		color: 				['colorless'],
		theme: 				['aoe','subtype_rat'],
		not_theme: 			['subtype_mage'],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/giant_growth.jpg',
		image_position: 	'top right',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{enlarge_creature: 2},
		quote: '\"Normally, I am not afraid of that, but now I am.\"',
		max_in_deck: 1,
	},
	...
	graverobber:{
		...
		hero_version: 			{
			theme: 				['type_creature','add_creature_card_to_deck_ability','add_creature_card_to_deck_ability','heal_hero_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{grave_power: 7, strike_unit: 1, summon_artifact: 2},
		},
		quote: '\"It\'s dirty work, but it can be very rewarding.\"',
	},
	green_ooze:{
		name: 				'green ooze',
		type: 				'creature',
		...
		armor: 				0,
		health: 			4,
		abilities: 			{strike: 1, venom: 1, stunning_touch: 5, foozion_2: 1},
		hero_version: 			{
	...
	healer:{
		...
		hero_version: 			{
			theme: 				['subtype_cleric','type_creature','fortify_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, heal: 1},
		},
		quote: '\"She may not be able to cure diseases, but she can stich up your wounds.\"',
	},
	healing_potion:{
		name: 				'healing potion',
		type: 				'artifact',
	...
	hideout:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{hide_ally: 1, echo: 1, righthand: 1},
	...
	house:{
		...
		hero_version: 			{
			theme: 				['type_creature','heal_ally_ability'],
	...
	last_meal:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/last_meal.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{heal_enemy: 3, doomed_healing: 3, echo: 1},
		quote: '\"Here, have a bite. You deserve it.\"',
	},
	leaf_caster:{
		name: 				'leaf caster',
		type: 				'creature',
	...
	leaf_cleric:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, regenerating_deaths: 1, regenerates_hv: 3},
		hero_version: 			{
			theme: 				['ally_creature_death_proc_ability','own_death_proc_ability','summon_creature_ability','grant_regeneration_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, regenerating_deaths: 1, regenerates_hv: 3},
		},
	...
	leafy_boots:{
		...
		subtypes: 			['gear'],
		color: 				['colorless'],
		theme: 				['grant_regeneration_ability'],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/leafy_boots.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{regenerating_arrivals: 2},
		quote: '\"Walking in those gives of a nice sent.\"',
	},
	leafy_potion:{
		name: 				'leafy potion',
		type: 				'artifact',
	...
	levitate:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/levitate.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{levitate: 4, draw_on_act: 1, righthand: 1},
		quote: '\"Look at me soar!\"',
		max_in_deck: 		1,
	},
	ligtning_strike:{
		name: 				'ligtning strike',
		type: 				'spell',
		subtypes: 			['arcane'],
		color: 				['colorless'],
		theme: 				['aoe','subtype_mage'],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/ligtning_strike.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{lightning: 6},
		quote: '\"I always hits the highest point!\"',
		max_in_deck: 		2,
	},
	lone_charge:{
		name: 				'lone charge',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/lone_charge.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{ally_charges: 2, echo: 1, maximum_allies: 1, righthand: 1},
		quote: '\"Charge them!\"',
		max_in_deck: 		1,
	},
	magic_dust:{
	...
	mammoth:{
		...
		quote: '\"Being hunted to near extinction in the past, these animals fear large groups.\"',
	},
	mana_beetle:{
		name: 				'mana beetle',
		type: 				'creature',
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, spellrush: 1, desperate_haste: 1},
		},
	...
	mana_cleric:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, hastening_deaths: 2},
		},
	...
	mana_druid:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{spell_bolt_hv: 1, healing_spells: 1, cleansing_spells: 1},
		},
		quote: '\"Her magic feeds forest.\"',
	},
	mana_leaf:{
		name: 				'mana leaf',
		type: 				'structure',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/mana_leaf.jpg',
		power: 				false,
		armor: 				0,
		health: 			1,
		abilities: 			{hasten: 1, regenerate_ally: 1, regrows: 8},
		hero_version: 			{
			theme: 				['draw_cards_ability','subtype_plant'],
			not_theme: 			['empower_hero_ability','damaging_hero'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{desperate_haste: 1, hasten: 1, regenerate_ally: 1},
		},
		quote: '\"A rare plant sought after by many mages.\"',
	},
	mana_orb:{
		name: 				'mana orb',
		type: 				'artifact',
	...
	mana_skeleton:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/mana_skeleton.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, triumphant_haste: 2, final_hasten: 1, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','draw_cards_ability','ally_creature_death_proc_ability','stabbing_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, hasten_on_kill: 1, desperate_haste: 1, resurrect_on_kill: 5, undead: 1},
		},
		quote: '\"A mage adept made a tiny mistake during a dangerous ritual.\"',
	},
	marid:{
		name: 				'marid',
		type: 				'creature',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/marid.jpg',
		image_position: 	'top',
		power: 				3,
		armor: 				0,
		health: 			6,
		abilities: 			{strike: 1, enemy_draws_cards: 5, flying: 5},
		hero_version: 			{
			theme: 				['flying_ability','discard_enemy_ability'],
			power: 				3,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, enemy_draws_cards: 1, flying: 5},
		},
		quote: '\"So powerful! There must be a catch...\"',
	},
	meadow:{
		name: 				'meadow',
		type: 				'structure',
	...
	messenger:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, draw_cards: 1, evade: 3},
		},
	...
	monk:{
		...
		hero_version: 			{
			theme: 				['buff_hero_ability','heal_hero_ability','subtype_cleric'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, bolster_self: 1},
		},
	...
	necromancer:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/necromancer.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, raise_dead: 4},
		hero_version: 			{
			theme: 				['ally_creature_death_proc_ability','summon_ally_creature_ability','subtype_witch'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, raise_dead: 4},
		},
		quote: '\"Rise! Rise again!\"',
	},
	orange_ooze:{
		name: 				'orange ooze',
		type: 				'creature',
	...
	pile_of_junk:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/pile_of_junk.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{summon_artifact: 10, call_rat: 1, fragile: 10},
	...
	plague_rat:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, venom: 1, spread_plague: 1, call_rat: 3},
		hero_version: 			{
			theme: 				['poison_ability','subtype_rat'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, venom: 1, spread_plague: 1, call_rat: 1},
		},
	...
	plague_skeleton:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, venom: 1, poison_aura: 1, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','poison_ability','ally_creature_death_proc_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, venom: 1, poison_aura: 1, resurrect_on_kill: 5, undead: 1},
		},
	...
	plated_boots:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/plated_boots.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{fortify_arrivals: 1},
		quote: '\"Makes your walks feel safe.\"',
		max_in_deck: 		1,
	},
	poison_fever:{
		name: 				'poison fever',
		...
		armor: 				0,
		health: 			false,
		abilities: 			{quicken_poison: 2, echo: 1, righthand: 1},
	...
	poisonous_boots:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/poisonous_boots.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{poison_arrivals: 1},
		quote: '\"Something smells funny...\"',
	},
	popcorn:{
		name: 				'popcorn',
		type: 				'artifact',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/popcorn.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{shoot_unit_av: 1, restore_chance: 50, fragile: 5},
		quote: '\"Those really hit the spot.\"',
		max_in_deck: 2,
	},
	protective_bubble:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{fortify_all: 1, echo: 1, righthand: 1},
	...
	pure_potion:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{pure_drink: 3, health_drink: 5, fragile_if_empty: 1},
		effects:{
			mana: 	1,
		},
		max_in_deck: 		1,
	...
	purple_ooze:{
		...
		armor: 				0,
		health: 			4,
		abilities: 			{strike: 1, cursed_touch: 1, stunning_touch: 5, foozion_2: 1},
		hero_version: 			{
	...
	pygmy_elephant:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/pygmy_elephant.jpg',
		...
		quote: '\"It might be small, but it can still do a lot!\"',
	},
	pyro_gecko:{
		name: 				'pyro gecko',
		type: 				'creature',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/pyro_gecko.jpg',
		image_position: 	'top right',
		power: 				1,
		armor: 				0,
		health: 			3,
		abilities: 			{strike: 1, fire_breathing: 2},
		hero_version: 			{
			theme: 				['burn_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, fire_breathing_hv: 2},
		},
		quote: '\"Cute, until it opens its mouth.\"',
	},
	pyromaniac:{
		name: 				'pyromaniac',
		type: 				'creature',
	...
	pyrosaur:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/pyrosaur.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			6,
		abilities: 			{fire_breathing: 2, empowering_fire: 1, strike: 1},
		hero_version: 			{
			theme: 				['burn_ability'],
			power: 				2,
			armor: 				0,
	...
	raging_bear:{
		...
		armor: 				0,
		health: 			6,
		abilities: 			{strike: 1, adrenaline: 5, enrage: 5},
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, adrenaline_hv: 1, enrage_hv: 5},
		},
		quote: '\"Do not poke the bear!\"',
	},
	rampaging_giant:{
		name: 				'rampaging giant',
		type: 				'creature',
		subtypes: 			['giant'],
		color: 				['colorless'],
		theme: 				[],
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/rampaging_giant.jpg',
		image_position: 	'top',
		power: 				3,
		armor: 				0,
		health: 			10,
		abilities: 			{destroy_on_play: 1, strike: 1, adrenaline: 10, minimum_enemies: 1},
		hero_version: 			{
			theme: 				['empower_ally_ability','buff_hero_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, adrenaline_hv: 2},
		},
		quote: '\"He leaves a trail of destruction.\"',
	},
	rat:{
		name: 				'rat',
		type: 				'creature',
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, call_rat: 3},
		hero_version: 			{
			theme: 				['subtype_rat'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, call_rat: 1},
		},
	...
	rat_king:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, call_rat: 3, empower_rat: 1, coward: 1},
		hero_version: 			{
			theme: 				['subtype_rat'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, call_rat: 1, empower_rat: 1, evade: 2},
		},
	...
	red_ooze:{
		...
		armor: 				0,
		health: 			4,
		abilities: 			{strike: 1, ignites: 1, stunning_touch: 5, foozion_2: 1},
		hero_version: 			{
	...
	ripe_banana:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/ripe_banana.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{hasten: 1, empower_hero: 1, fragile: 25},
		quote: '\"A good source of energy, but they spoil so quickly.\"',
		max_in_deck: 3,
	},
	rock_biter:{
		name: 				'rock biter',
	...
	rock_seer:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, doom_stunned: 1, initiate_earthquake: 1},
		hero_version: 			{
			theme: 				['stun_ability','doom_ability','flying_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, doom_stunned: 1, initiate_earthquake: 1},
		},
	...
	root_monster:{
		...
		armor: 				0,
		health: 			8,
		abilities: 			{strike: 1, fearful_aura: 1, regenerates_hv: 3},
		hero_version: 			{
			theme: 				['subtype_plant','run_away_ability','charge_ability','grant_regeneration_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, fearful_hero: 3, regenerates_hv: 3},
		},
	...
	scarecrow:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{slow: 1, fearful_aura: 1, turn_cursed_scarecrow: 1},
		hero_version: 			{
	...
	scribe:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, draw_cards: 1},
		},
	...
	sentinel:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/sentinel.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			8,
		abilities: 			{strike: 1, guard: 1, desperate_power: 1},
		hero_version: 			{
			theme: 				['subtype_warrior','movement_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, ally_guards: 1, enrage_hv: 5},
		},
		quote: '\"You will not strike at our hero!\"',
	},
	sheep:{
		name: 				'sheep',
		type: 				'creature',
		...
		hero_version: 			{
			theme: 				['fortify_ability','cleanse_ally_ability','empower_ally_ability','heal_ally_ability','buff_hero_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
	...
	shield_mage:{
		name: 				'shield mage',
		type: 				'creature',
		subtypes: 			['human','mage','warrior'],
		color: 				['colorless'],
		theme: 				[],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/shield_mage.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			5,
		abilities: 			{arcane_bolt: 2, fortify_self: 1},
		hero_version: 			{
			theme: 				['fortify_ability','subtype_mage'],
			not_theme: 			['empower_hero_ability','empower_ally_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
		...
		quote: '\"A mage trained for close combat.\"',
	},
	shieldman:{
		name: 				'shieldman',
		type: 				'creature',
	...
	skeletal_guard:{
		name: 				'skeletal guard',
		type: 				'creature',
		subtypes: 			['undead','warrior'],
		color: 				['colorless'],
		theme: 				[],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/skeletal_guard.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, guard: 1, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','ally_creature_death_proc_ability','subtype_warrior'],
			power: 				3,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, ally_guards: 1, resurrect_on_kill: 5, undead: 1},
		},
		quote: '\"They died guarding their kingdom once. Now they will do so again.\"',
	},
	skeletal_knight:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/skeletal_knight.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			1,
		abilities: 			{charge: 1, strike: 1, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','ally_creature_death_proc_ability','subtype_warrior'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, ally_charges: 1, resurrect_on_kill: 5, undead: 1},
		},
		quote: '\"They died riding their steed into battle. Their bond was never broken. Now they ride again.\"',
	},
	skeletal_mage:{
		name: 				'skeletal mage',
		type: 				'creature',
		subtypes: 			['undead','mage'],
		color: 				['colorless'],
		theme: 				[],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/skeletal_mage.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			1,
		abilities: 			{arcane_bolt: 1, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['resurrect_ability','magical_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{arcane_bolt_hv: 2, resurrect_on_kill: 5, undead: 1},
		},
		quote: '\"Once a great mage, it came back using dark magic.\"',
	},
	skeletal_soldier:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/skeletal_soldier.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, fortify_self: 1, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','ally_creature_death_proc_ability','subtype_warrior'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, fortify_self: 1, resurrect_on_kill: 5, undead: 1},
		},
		quote: '\"They died fighting for their kingdom once. Now they will do so again.\"',
	},
	skeleton:{
		name: 				'skeleton',
		type: 				'creature',
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','ally_creature_death_proc_ability'],
			power: 				3,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, resurrect_on_kill: 5, undead: 1},
		},
	...
	sleeping_giant:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/sleeping_giant.jpg',
		image_position: 	'top',
		power: 				0,
		armor: 				0,
		health: 			12,
		abilities: 			{strike_arrivals: 10, strike_moving: 1, strike: 1, enrage: 10},
		hero_version: 			{
			theme: 				['buff_hero_ability','heal_hero_ability'],
			power: 				0,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_arrivals: 10, strike_moving: 1, strike_unit: 1, enrage_hv: 10},
		},
		quote: '\"Do not disturb the giant!\"',
	},
	slow_burn:{
		name: 				'slow burn',
		type: 				'spell',
	...
	slimeling:{
		...
		armor: 				0,
		health: 			2,
		abilities: 			{strike: 1, stunning_touch: 5, foozion: 1},
		hero_version: 			{
	...
	slimy_skeleton:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, stunning_touch: 3, trap: 3, resurrect: 1, resurrect_on_kill: 10, undead: 1},
		hero_version: 			{
			theme: 				['resurrect_ability','subtype_slime','stun_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, stunning_touch: 3, trap: 3, resurrect_on_kill: 5, undead: 1},
		},
	...
	soul_cord:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{soul_link: 2},
		quote: '\"You will stay connected to your hero.\"',
	},
	soul_harvest:{
		name: 				'soul harvest',
		type: 				'spell',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/soul_harvest.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{reap_all: 1, trophy_kill: 3, echo: 1},
	...
	soul_power:{
		...
		subtypes: 			['ritual'],
		color: 				['colorless'],
		theme: 				['resurrect_ability','ally_creature_death_proc_ability'],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/soul_power.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{soul_power: 2, draw_on_act: 1, righthand: 1},
		quote: '\"Free the power of your soul.\"',
		max_in_deck: 		1,
	},
	spell_mage:{
		name: 				'spell mage',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/spell_mage.jpg',
		image_position: 	'top left',
		power: 				false,
		armor: 				0,
		health: 			5,
		abilities: 			{arcane_bolt: 1, spell_bolt: 1, bring_spell: 1},
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{arcane_bolt_hv: 1, spell_bolt_hv: 1, write_spell: 1},
		},
		quote: '\"She controls the magical energy.\"',
	},
	spike_trap:{
	...
	steak:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/steak.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{restore: 1, empower_hero: 1, fragile: 5},
		quote: '\"A good meal before battle makes a lot of difference.\"',
	},
	stuffed_pepper:{
		name: 				'stuffed pepper',
		type: 				'artifact',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/stuffed_pepper.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{burning_hero: 1, fragile: 6},
		quote: '\"Come and have a bite! It\'s not spicy at all!\"',
	},
	sundrew:{
		name: 				'sundrew',
		type: 				'structure',
	...
	surprise_attack:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/surprise_attack.jpg',
		image_position: 	'top right',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{surprise_attack: 2, echo: 1, righthand: 1},
		quote: '\"It\'s a matter of getting the jump on your enemy.\"',
		max_in_deck: 		2,
	},
	sword:{
		name: 				'sword',
	...
	tactical_retreat:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/tactical_retreat.jpg',
		power: 				false,
		armor: 				0,
		health: 			false,
		abilities: 			{unsummon_ally: 1, echo: 1},
		quote: '\"I\'m not scared! I\'m just tactically retreating.\"',
		max_in_deck: 1,
	},
	taipan:{
		name: 				'taipan',
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, venom: 2, counter: 1},
		},
		quote: '\"Large, but have a fast venomous bite. Do not go near them.\"',
	},
	thief:{
		name: 				'thief',
		type: 				'creature',
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, break_hv: 2, evade: 3},
		},
	...
	thug:{
		...
		armor: 				0,
		health: 			4,
		abilities: 			{strike: 1, plunder: 7},
		hero_version: 			{
			theme: 				['subtype_rogue'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, break_hv: 1},
		},
	...
	torchbearer:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, ignites: 1, cleanse: 1},
		hero_version: 			{
			theme: 				['burn_ability','cleanse_ally_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, ignites: 2, cleanse: 1},
		},
	...
	tremor:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{ground_shake: 1, initiate_earthquake: 1, long_echo: 1},
	...
	venom_mage:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/venom_mage.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			5,
		abilities: 			{arcane_bolt: 2, venom: 2},
		hero_version: 			{
			theme: 				['poison_ability','subtype_mage'],
			not_theme: 			['empower_hero_ability','empower_ally_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{arcane_bolt_hv: 1, venom: 2},
		},
		quote: '\"Her magic is infused with poison.\"',
	},
	venom_witch:{
		name: 				'venom witch',
		type: 				'creature',
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, venom: 2, cursed_touch: 1},
		hero_version: 			{
			theme: 				['curse_ability','poison_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, venom: 2, cursed_touch: 1},
		},
	...
	viking:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/viking.jpg',
		image_position: 	'top',
		power: 				3,
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, plunder: 10, fortify_self: 1},
		hero_version: 			{
			theme: 				['burn_ability','subtype_warrior'],
			power: 				3,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, break_hv: 1, fortify_self: 1},
		},
		quote: '\"Ready to raid and plunder.\"',
	},
	village_defender:{
	...
	vine_slime:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, stunning_touch: 3, regenerates_hv: 3},
		hero_version: 			{
			theme: 				['subtype_slime','subtype_plant','grant_regeneration_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, stunning_touch: 3, regenerates_hv: 3},
		},
		quote: '\"I\'m not sure what it is, but it sure is sticky.\"',
	},
	volcanic_warrior:{
		name: 				'volcanic warrior',
		type: 				'creature',
		subtypes: 			['human','warrior'],
		color: 				['colorless'],
		theme: 				[],
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/volcanic_warrior.jpg',
		image_position: 	'top',
		power: 				3,
		armor: 				0,
		health: 			6,
		abilities: 			{strike: 1, burning_aura: 1, resist_fire: 1},
		hero_version: 			{
			theme: 				['burn_ability','subtype_warrior'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, burning_aura: 1, resist_fire: 1},
		},
		quote: '\"Heat radiates from his armour.\"',
	},
	volcano_dancer:{
		name: 				'volcano dancer',
		type: 				'creature',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/volcano_dancer.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, evade: 5, resist_fire: 1},
		hero_version: 			{
			theme: 				['burn_ability','subtype_rogue','evade_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, evade: 5, resist_fire: 1},
		},
		quote: '\"I love to dance in the heat.\"',
	},
	wall:{
		name: 				'wall',
		type: 				'structure',
	...
	wall_of_cinder:{
		...
		subtypes: 			['wall'],
		color: 				['colorless'],
		theme: 				['structure_death_proc_ability'],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/wall_of_cinder.jpg',
		power: 				false,
		armor: 				0,
		health: 			1,
		...
		quote: '\"Let them come and touch it.\"',
	},
	wall_of_thorns:{
		name: 				'wall of thorns',
		type: 				'structure',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/wall_of_thorns.jpg',
		power: 				false,
		armor: 				0,
		health: 			6,
		abilities: 			{thorns: 1},
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{thorns: 2, regenerates_hv: 4},
		},
		quote: '\"Be careful! It\'s prickly.\"',
	},
	wall_of_vines:{
		name: 				'wall of vines',
		type: 				'structure',
	...
	wanderer:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, empower_arrivals: 10, evade: 3},
		},
		quote: '\"The forest will give me cover.\"',
	},
	wanton_fire_caster:{
		name: 				'wanton fire caster',
		type: 				'creature',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/wanton_fire_caster.jpg',
		image_position: 	'top',
		power: 				false,
		armor: 				0,
		health: 			4,
		abilities: 			{burning_entry: 1, arcane_bolt: 1, ignites: 1},
		hero_version: 			{
	...
	wanton_girl:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/wanton_girl.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			4,
		abilities: 			{burning_entry: 1, strike: 1},
		hero_version: 			{
			theme: 				['subtype_wanton','burn_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, burn_hv: 2},
		},
		quote: '\"Touch her and you will burn yourself.\"',
	},
	warden:{
		name: 				'warden',
		type: 				'creature',
	...
	warrior_druid:{
		...
		abilities: 			{strike: 1, heal: 1, cleanse: 2},
		hero_version: 			{
			theme: 				['subtype_cleric','type_creature','subtype_warrior'],
			power: 				2,
			armor: 				0,
			health: 			40,
	...
	warrior_monk:{
		...
		hero_version: 			{
			theme: 				['buff_hero_ability','heal_hero_ability','subtype_warrior'],
			power: 				2,
			armor: 				0,
			health: 			40,
	...
	whisp:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/whisp.jpg',
		power: 				false,
		armor: 				0,
		health: 			1,
		abilities: 			{vengeance: 1, flying: 4, resurrect: 1, resurrect_on_kill: 5, undead: 1},
		hero_version: 			{
			theme: 				['ally_creature_death_proc_ability','own_death_proc_ability','summon_creature_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{vengeance_hv: 1, flying: 4, resurrect_on_kill: 5, undead: 1},
		},
	...
	winged_wanton:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/winged_wanton.jpg',
		image_position: 	'top',
		power: 				1,
		armor: 				0,
		health: 			4,
		abilities: 			{burning_entry: 1, strike: 1, flying: 4},
		hero_version: 			{
			theme: 				['subtype_wanton','burn_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, burn_hv: 1, flying: 4},
		},
		quote: '\"She sold her soul for a pair of wings.\"',
	},
	witch:{
		name: 				'witch',
		type: 				'creature',
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, cursed_touch: 1, cursed_aura: 1},
		hero_version: 			{
			theme: 				['curse_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 1, cursed_aura: 1},
		},
	...
	witchs_hut:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{call_witch: 2, cursed_aura: 1},
		hero_version: 			{
	...
	zombie:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/zombie.jpg',
		image_position: 	'top',
		power: 				2,
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, feast: 1, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','curse_ability','buff_hero_ability'],
			power: 				3,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, feast: 1, undead: 1},
		},
		quote: '\"It wants brains, but will gnaw on bones if it has to.\"',
	},
	zombie_mage:{
		name: 				'zombie mage',
		type: 				'creature',
		...
		armor: 				0,
		health: 			5,
		abilities: 			{arcane_bolt: 2, feast: 1, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','curse_ability','damaging_hero'],
			not_theme: 			['empower_hero_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
		...
		quote: '\"If it hits you, it will come for you.\"',
	},
	zombie_warrior:{
		name: 				'zombie warrior',
		type: 				'creature',
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/zombie_warrior.jpg',
		image_position: 	'top',
		power: 				3,
		armor: 				0,
		health: 			6,
		abilities: 			{strike: 1, feast: 1, fortify_self: 1, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','curse_ability','buff_hero_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, feast: 1, fortify_self: 1, undead: 1},
		},
		quote: '\"The fighting does not end, even after death.\"',
	},
	zombie_witch:{
		name: 				'zombie witch',
		type: 				'creature',
		subtypes: 			['undead','witch'],
		color: 				['colorless'],
		theme: 				[],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/zombie_witch.jpg',
		image_position: 	'top',
		power: 				2,
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, cursed_touch: 2, feast: 1, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','curse_ability','buff_hero_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 2, feast: 1, undead: 1},
		},
		quote: '\"Her touch is one of decay.\"',
	},
