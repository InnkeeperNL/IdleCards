var all_available_cards = {
	...
	falcon:{
		...
		armor: 				0,
		health: 			2,
		abilities: 			{seek_enemy: 1, strike: 1, adrenaline: 8, flying: 4},
		hero_version: 			{
			theme: 				['evade_ability','empower_hero_ability','buff_hero_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, adrenaline_hv: 3, flying: 4},
		},
	...
	wall_of_cinder:{
		...
		subtypes: 			['wall'],
		color: 				['colorless'],
		theme: 				['summon_structure_ability','aoe'],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
