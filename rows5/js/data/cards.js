var all_available_cards = {
	...
	grinning_witch:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, cursed_stuns: 4},
		hero_version: 			{
			theme: 				['stun_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_stuns_hv: 4},
		},
	...
	witch:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, cursed_touch: 2, cursed_aura: 1},
		hero_version: 			{
			theme: 				['curse_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 2, cursed_aura: 1},
		},
	...
	witchs_hut:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{call_witch: 2, cursed_aura: 2},
		hero_version: 			{
