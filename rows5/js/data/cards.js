var all_available_cards = {
	...
	cursed_skeleton:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 1, cursed_aura: 1, resurrect: 10, undead: 1},
		},
	...
	mana_skeleton:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, triumphant_haste: 2, final_hasten: 1, resurrect: 5, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','draw_cards_ability','ally_creature_death_proc_ability','stabbing_ability'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, hasten_on_kill: 1, desperate_haste: 1, resurrect: 10, undead: 1},
		},
	...
	plague_skeleton:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, venom: 1, poison_aura: 1, resurrect: 10, undead: 1},
		},
	...
	skeletal_guard:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, guard: 1, resurrect: 5, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','ally_creature_death_proc_ability','subtype_warrior'],
			power: 				3,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, ally_guards: 1, resurrect: 10, undead: 1},
		},
	...
	skeletal_knight:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{charge: 1, strike: 1, resurrect: 8, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','ally_creature_death_proc_ability','subtype_warrior'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, ally_charges: 1, resurrect: 10, undead: 1},
		},
	...
	skeletal_mage:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{arcane_bolt: 1, resurrect: 5, undead: 1},
		hero_version: 			{
			theme: 				['resurrect_ability','magical_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{arcane_bolt_hv: 2, resurrect: 10, undead: 1},
		},
	...
	skeletal_soldier:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, fortify_self: 1, resurrect: 5, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','ally_creature_death_proc_ability','subtype_warrior'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, fortify_self: 1, resurrect: 10, undead: 1},
		},
	...
	slimy_skeleton:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, stunning_touch: 3, trap: 3, resurrect: 10, undead: 1},
		},
	...
	whisp:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{vengeance: 1, flying: 4, resurrect: 5, undead: 1},
		hero_version: 			{
			theme: 				['ally_creature_death_proc_ability','own_death_proc_ability','summon_creature_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{vengeance_hv: 1, flying: 4, resurrect: 10, undead: 1},
		},
