var all_available_cards = {
	...
	arcane_druid:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{arcane_bolt: 1, heal: 1, cleanse: 1},
		hero_version: 			{
	...
	druid:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, heal: 1, cleanse: 1},
		hero_version: 			{
	...
	house:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{heal: 2, cleanse: 1, fortify_ally: 1},
		},
	...
	zombie_mage:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{arcane_bolt: 2, feast: 2, undead: 1},
		hero_version: 			{
	...
	zombie_warrior:{
		...
		armor: 				0,
		health: 			6,
		abilities: 			{strike: 1, feast: 2, fortify_self: 1, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','curse_ability','buff_hero_ability'],
			power: 				3,
			armor: 				0,
	...
	zombie_witch:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, cursed_touch: 2, feast: 2, undead: 1},
		hero_version: 			{
			theme: 				['subtype_undead','curse_ability','buff_hero_ability'],
			power: 				2,
			armor: 				0,
