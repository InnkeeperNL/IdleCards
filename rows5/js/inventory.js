			...
			if(all_available_cards[current_consumable]['reward']['type'] == 'random_card')
			{
			    ...
			    for (var picking = amount_used - 1; picking >= 0; picking--) {
				    ...
				    for(i = 0; i < pick_amount; i++){
						...
						{
							gained_card = get_random_card_based_on_value(all_available_cards[current_consumable]['reward']['min_value'], all_available_cards[current_consumable]['reward']['color'],all_available_cards[current_consumable]['reward']['card_type'], true, gained_cards, all_available_cards[current_consumable]['reward']['max_value'], all_available_cards[current_consumable]['reward']['rare_chance']);
						}
