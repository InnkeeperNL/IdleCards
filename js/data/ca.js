...
var all_available_cards = {
	...
	air_mage:{
		...
		hero_version: 			{
			theme: 				['air_ability','projectile_ability','subtype_mage','flying_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
	...
	angler:{
		...
		hero_version: 			{
			theme: 				['subtype_aquatic','subtype_human'],
			power: 				3,
			armor: 				0,
			health: 			40,
	...
	arcane_trickster:{
		...
		hero_version: 			{
			theme: 				['arcane_bolts_ability','subtype_mage','curse_ability','run_away_ability'],
			power: 				false,
			armor: 				0,
			health: 			30,
	...
	archaeologist:{
		...
		hero_version: 			{
			theme: 				['type_artifact','subtype_human'],
			power: 				1,
			armor: 				0,
			health: 			40,
	...
	bank:{
		...
		armor: 				0,
		health: 			10,
		abilities: 			{life_cost: 2, bolster_hero: 2},
		hero_version: 			{
			theme: 				['type_creature','subtype_human','active_healing_ability','fortify_ability','cleanse_ally_ability'],
			power: 				false,
			armor: 				0,
	...
	bramble_witch:{
		...
		hero_version: 			{
			theme: 				['thorns_ability','subtype_witch'],
			power: 				1,
			armor: 				0,
			health: 			30,
	...
	brown_dragon:{
		...
		hero_version: 			{
			theme: 				['bolster_ability','subtype_dragon'],
			power: 				1,
			armor: 				0,
			health: 			30,
	...
	echo_mage:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, bring_clone: 1, homebound: 1},
		hero_version: 			{
	...
	fishing_boat:{
		...
		abilities: 			{strike: 1, trap: 1},
		hero_version: 			{
			theme: 				['subtype_aquatic','subtype_ship'],
			power: 				3,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, trap: 1},
	...
	fungal_gnasher:{
		...
		armor: 				0,
		health: 			4,
		abilities: 			{consume_creature: 1, strike: 1, feast: 3, spawn_sporeling: 1},
		hero_version: 			{
			theme: 				['subtype_fungus','type_creature'],
			power: 				1,
			armor: 				0,
	...
	group_meditation:{
		...
		theme: 				[],
		not_theme: 			['type_structure','subtype_undead'],
		craft_theme: 		['bless','bless','bless','bolster'],
		pick_chance: 		1,
		time: 				1,
	...
	guard_dog:{
		...
		hero_version: 			{
			theme: 				['empower_ability','subtype_animal','guard_ability'],
			power: 				3,
			armor: 				0,
			health: 			40,
	...
	orange_dragon:{
		...
		hero_version: 			{
			theme: 				['empower_ability','subtype_dragon'],
			power: 				1,
			armor: 				0,
			health: 			30,
	...
	sea_giant:{
		...
		hero_version: 			{
			theme: 				['subtype_giant','subtype_aquatic'],
			power: 				1,
			armor: 				0,
			health: 			30,
