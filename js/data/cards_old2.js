var all_older_available_cards = {
	...
	candle_bearer:{
		...
		armor: 				0,
		health: 			7,
		abilities: 			{strike: 1, light_candle: 1},
		hero_version: 			{
			name: 				'candle bearer',
			type: 				'creature',
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, light_candle: 1},
		},
		recipe:{
			dark_seer: 			1,
			execution: 			1,
	...
	cockroach:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, pierces: 1},
		},
		recipe:{
			ghoul: 					1,
			painful_sacrifice: 		1
	...
	conscription:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{summon_guard: 1, spell_echo: 1},
		recipe:{
			castle: 			1,
			soldier_of_faith: 	1,
		},
	...
	cursed_lands:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{no_allies: 1, curse_all_life: 1},
		recipe:{
			ambush: 			1,
			ravine: 			1,
		},
	...
	tree_basilisk:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, poisonous: 1},
		},
		recipe:{
			grove_mystic: 	1,
			water_snake: 	1,
