var all_older_available_cards = {
	...
	cockroach:{
		...
		color: 				['purple'],
		theme: 				['ally_creature_death_proc_ability','ally_creature_card_played_proc_ability'],
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/cockroach.jpg',
		power: 				1,
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, eternal: 1},
		hero_version: 			{
	...
	flame_dancer:{
		...
		pick_chance: 		1,
		time: 				8,
		image: 				'cards/flame_dancer.jpg',
		image_position: 	'top',
		power: 				2,
		armor: 				0,
		health: 			7,
		abilities: 			{strike: 1, move: 1, burning_aura: 2},
		hero_version: 			{
	...
	heart_of_fire:{
		...
		subtypes: 			['ritual'],
		color: 				['red'],
		theme: 				['ally_creature_death_proc_ability','own_death_proc_ability','resurrect_ability'],
		pick_chance: 		0.7,
		time: 				2,
		...
		quote: '\"It will bring out your inner fire.\"',
	},
	hexing_witch:{
		name: 				'hexing witch',
		version: 			2,
	...
	honorbound_warrior:{
		...
		pick_chance: 		1,
		time: 				6,
		image: 				'cards/honorbound_warrior.jpg',
		image_position: 	'top',
		power: 				6,
		armor: 				0,
		health: 			6,
		...
		quote: '\"Battles have been fought in the past. She swore not to fight without honor again. Even the enemey deserves to be treated with respect.\"',
	},
	lava_whelp:{
		name: 				'lava whelp',
		version: 			2,
	...
	mausoleum:{
		...
		quote: '\"It calls for you to join the dead.\"',
	},
	monk:{
		name: 				'monk',
		type: 				'creature',
	...
	mountain_elf:{
		...
		quote: '\"They found some old dwarven \'tools\'.\"',
	},
	natures_touch:{
		name: 				'nature\'s touch',
		version: 			2,
	...
	red_salamander:{
		...
		pick_chance: 		1,
		time: 				5,
		image: 				'cards/red_salamander.jpg',
		power: 				2,
		armor: 				0,
		health: 			7,
