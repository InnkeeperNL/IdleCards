var all_oldest_available_cards = {
	...
	bard:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{empower_ally: 1, strike: 1, charming_touch: 1},
		hero_version: 			{
			power: 				1,
			armor: 				0,
			health: 			45,
			abilities: 			{strike_unit: 1, charming_touch: 1, empower_ally: 1},
		},
	},
	bee:{
		name: 				'bee',
	...
	mesmer:{
		...
		armor: 				0,
		health: 			4,
		abilities: 			{arcane_bolt: 1, charming_touch: 1},
		hero_version: 			{
			name: 				'mesmer',
			type: 				'creature',
			image: 				'cards/fantasy-5410210_640.jpg',
			...
			armor: 				0,
			health: 			60,
			abilities: 			{arcane_bolt_hv: 1, charming_touch: 1},
		},
	},
	mammoth:{
		name: 				'mammoth',
	...
	veteran_seer:{
		...
		quote: '\"The years sharpen no eye like the one that has seen too much.\"',
	},
	viking:{
		name: 				'viking',
		type: 				'creature',
	...
	voodoo_doll:{
		...
		armor: 				0,
		health: 			6,
		abilities: 			{damage_hero: 1},
		hero_version: 			{
			theme: 				['subtype_witch'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{withering_aura: 2},
		},
		recipe:{
			lumber: 			1,
			amethyst: 			1
