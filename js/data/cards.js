var all_available_cards = {
	...
	arcane_elf_mage:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{arcane_bolt_hv: 3, resist_magic: 1},
		},
	...
	battle_shout:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{empower_all: 3, minimum_allies: 3},
		quote: '\"Attack!\"',
	},
	bear:{
		name: 				'bear',
	...
	black_cat:{
		...
		armor: 				0,
		health: 			2,
		abilities: 			{strike: 1, cursed_touch: 4},
		hero_version: 			{
			theme: 				['curse_ability','subtype_animal'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 3},
		},
	...
	blessed_assassin:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, stealth: 1, blessed: 1},
		hero_version: 			{
			theme: 				['subtype_cleric','subtype_rogue','bless_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, hide: 1, bless: 1},
		},
	...
	blessed_guard:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, guard: 1, blessed: 1},
		hero_version: 			{
			theme: 				['subtype_cleric','subtype_warrior','bless_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
	...
	blessed_rogue:{
		...
		armor: 				0,
		health: 			3,
		abilities: 			{strike: 1, evade: 1, blessed: 1},
		hero_version: 			{
			theme: 				['subtype_cleric','subtype_rogue','bless_ability'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, evade: 1, bless: 1},
		},
	...
	crow:{
		...
		armor: 				0,
		health: 			2,
		abilities: 			{strike: 1, cursed_touch: 1, flying: 1},
		hero_version: 			{
			theme: 				['flying_ability','subtype_animal'],
			power: 				2,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, cursed_touch: 1, flying: 1},
		},
	...
	cull_the_weak:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{reap_all: 2, minimum_enemies: 3},
	...
	druid:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/dream_TradingCard93.jpg',
		power: 				1,
		armor: 				0,
		health: 			5,
	...
	elf_druid:{
		...
		pick_chance: 		1,
		time: 				1,
		image: 				'cards/dream_TradingCard94.jpg',
		power: 				1,
		armor: 				0,
		health: 			4,
	...
	flag_carrier:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{empower_ally: 2, strike: 1},
		hero_version: 			{
			theme: 				['melee_ability','subtype_warrior'],
			power: 				2,
			armor: 				0,
	...
	iceblade:{
		...
		quote: '\"My blades burn for blood.\"',
	},
	ice_wand:{
		name: 				'ice wand',
		type: 				'artifact',
	...
	imp_lord:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{flame_strike_hv: 1, empower_imps: 1},
		},
		quote: '\"Fear my army!\"',
	},
	imp_warrior:{
	...
	power_drain:{
		...
		armor: 				0,
		health: 			false,
		abilities: 			{debilitate_all: 2, minimum_enemies: 3},
	...
	searing_orb:{
		...
		color: 				['colorless'],
		theme: 				[],
		craft_theme: 		['burn_ability','burn_ability'],
		pick_chance: 		1,
		time: 				1,
	...
	skeletal_apprentice:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{fire_bolt_hv: 3, undead: 1, resurrect: 1},
		},
	...
	skeletal_knight:{
		...
		armor: 				0,
		health: 			1,
		abilities: 			{strike: 1, undead: 1, resurrect: 1, plated: 1},
		hero_version: 			{
			theme: 				['subtype_undead','subtype_skeleton','on_death_proc_ability'],
			power: 				2,
			armor: 				0,
	...
	skeletal_mage:{
		...
		hero_version: 			{
			...
			armor: 				0,
			health: 			40,
			abilities: 			{arcane_bolt_hv: 3, undead: 1, resurrect: 1},
		},
