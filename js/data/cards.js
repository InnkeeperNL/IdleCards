var all_available_cards = {
	...
	altar_of_sacrifice:{
		...
		armor: 				0,
		health: 			6,
		abilities: 			{sacrifice_living_creature: 1, cursed_deaths: 1, restoring_deaths: 1},
		hero_version: 			{
			theme: 				['summon_creature_ability','resurrect_ability','own_death_proc_ability'],
			power: 				false,
			armor: 				0,
			health: 			40,
			abilities: 			{cursed_deaths: 2, restoring_deaths: 1},
		},
		quote: '\"The price of immortality.\"',
	},
	arcane_apprentice:{
