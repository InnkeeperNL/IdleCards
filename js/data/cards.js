...
var all_available_cards = {
	...
	blacksmith:{
		...
		armor: 				0,
		health: 			5,
		abilities: 			{strike: 1, fortify: 1, empowering_shields: 1},
		hero_version: 			{
			theme: 				['fortify_ability','subtype_human'],
			power: 				1,
			armor: 				0,
			health: 			40,
			abilities: 			{strike_unit: 1, fortify: 1, empowering_shields: 1},
		},
	...
	smiths_hammer:{
		...
		subtypes: 			['tool'],
		color: 				['colorless'],
		theme: 				['plated_ability', 'empower_ability'],
		craft_theme: 		[],
		pick_chance: 		1,
		time: 				1,
		...
		armor: 				0,
		health: 			false,
		abilities: 			{empowering_shields: 1},
