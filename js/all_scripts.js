...
function check_current_offers(){
	...
	console.log('ding');
		if(current_building['current_offers'][i] != undefined && (new Date(current_building['current_offers'][i]['offer_expires']) < new Date() || typeof(current_building['current_offers'][i]['offer_expires']) == 'object'))
		{
