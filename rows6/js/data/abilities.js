...
var all_abilities = {
	add_ignite:{
		...
		effects:{
			0:{
				...
				subtypes: 	['summon_ally','summon_spell','add_spell_card_to_deck'],
				card_id: 	'ignite',
				card_status: 	'deck',
	...
	bolster_creature:{
		description: 	'A random non-undead ally creature gains {LEVEL} health.',
		proc: 			'basic',
		cannot_proc_while_stunned: true,
		scales: 		true,
	...
	bolster_hero:{
		...
		effects:{
			0:{
				projectile: 	'bolster',
				type: 			'increase_health',
				subtypes: 		['bolster','heal_hero','buff_hero'],
				amount: 		'ability_level'
			},
		},
		animation: 			'combat_zoom',
	...
	bring_armor:{
		description: 	'When played, this grants all allies {LEVEL} shield.{SHIELD}',
		proc: 			'on_play',
		cannot_proc_while_stunned: true,
		do_not_pause_between: true,
		scales: 		true,
	...
	bring_spell:{
		...
		effects:{
			0:{
				...
				projectile_target: 	'true_deck',
				type: 		'add_card_to_deck',
				subtypes: 	['summon_ally','summon_rat','summon_creature','add_spell_card_to_deck'],
				card_id: 	'random',
				card_type: 	'spell',
				card_status: 	'hand',
				amount: 	1
	...
	call_rat:{
		...
		effects:{
			0:{
				...
				projectile_target: 	'true_deck',
				type: 		'add_card_to_deck',
				subtypes: 	['summon_ally','summon_rat','summon_creature','add_creature_card_to_deck'],
				card_id: 	'rat',
				//card_subtype: 	'rat',
				card_status: 	'hand',
				amount: 	1
	...
	call_witch:{
		...
		effects:{
			0:{
				...
				projectile_target: 	'true_deck',
				type: 		'add_card_to_deck',
				subtypes: 	['summon_ally','summon_witch','summon_creature','add_creature_card_to_deck'],
				card_id: 	'random',
				card_type: 	'creature',
				card_subtype: 	'witch',
				card_status: 	'hand',
	...
	cleanse:{
		description: 	'Removes {LEVEL} negative effect(s) from a random ally.',
		cannot_proc_while_stunned: true,
		//do_not_pause_between: true,
		proc_amount: 	'ability_level',
		scales: 		true,
	...
	empowering_arrivals:{
		description: 	'When any ally creature unit enters the game, this has a {LEVEL}0% chance to gain 1 power.',
		proc: 			'ally_unit_card_played',
		cannot_proc_while_stunned: true,
		origin_not_self: 	true,
		proc_chance:  	10,
	...
	empowering_arrivals_hv:{
		name: 			'empowering arrivals',
		description: 	'When any ally creature unit enters the game, this has a {LEVEL}0% chance to gain 1 temporary power.',
		proc: 			'ally_unit_card_played',
		cannot_proc_while_stunned: true,
		origin_not_self: 	true,
		proc_chance:  	10,
	...
	fortify:{
		name: 			'shield ally',
		description: 	'This gants a random ally {LEVEL} shield.{SHIELD}',
		cannot_proc_while_stunned: true,
		scales: 		true,
		targets:	{
			0:{
	...
	initiate_earthquake:{
		...
		effects:{
			0:{
				...
				projectile_target: 	'true_deck',
				type: 		'add_card_to_deck',
				subtypes: 	['add_spell_card_to_deck'],
				card_id: 	'earthquake',
				card_status: 	'deck',
				amount: 	1
			}
	...
	mob_mentality:{
		description: 	'When any ally human enters the game, this has a {LEVEL}0% chance to gain 1 power.',
		proc: 			'ally_unit_card_played',
		cannot_proc_while_stunned: true,
		origin_not_self: 	true,
...
eachoa(all_abilities, function(ability_id, ability_info){
	...
	all_abilities[ability_id]['description'] = ability_info['description'].split("{SHIELD}").join('<br/><i>Shield: Deflect projectiles and absorbs the first incoming damage. Deflecting a projectile reduces the shield by 1. Absorbing damage removes the shield.</i>');
