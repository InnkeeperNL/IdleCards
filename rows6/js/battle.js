...
function check_deck_min_enemy_targets(random_deck, deck_theme, not_these, not_theme){
	...
	if(min_enemies_ability_count + 1 <= deck_size / 10)
	{
		...
		if(new_card != false && match_array_values(all_available_cards[new_card]['theme'], theme_to_check) == false)
		{
...
function get_random_card_based_on_time(type, max_time, color_restriction, second_color_restriction, card_subtype, min_time, not_these, not_subtypes){
	if(card_subtype != undefined && typeof(card_subtype) == 'string')
	{
